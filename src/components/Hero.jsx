  ...
  return (
    <div className="w-full h-screen relative">
      <video
        ...
        src={beachVid}
      />
      <div className="w-full h-full top-0 left-0 bg-gray-700/10"></div>
      <div className="absolute top-0 w-full h-full flex flex-col justify-center text-center text-white p-6">
        ...
        <form
          className="flex justify-between items-center max-w-[550px] mx-auto w-full border p-1 rounded-md
